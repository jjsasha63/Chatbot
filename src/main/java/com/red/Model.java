...
public class Model {
    ...
    static DoccatModel model_train() throws IOException {
        DoccatFactory factory = new DoccatFactory(new FeatureGenerator[]{new BagOfWordsFeatureGenerator()});
        InputStreamFactory inputStreamFactory = new MarkableFileInputStreamFactory(new File("src/categorizer1.txt"));
    ...
    static String[] breaks(String val) throws IOException{
    ...
    static String[] lemma(String[] pos, String[] tk)throws  IOException{
    ...
    static String[] pos(String[] tk)throws IOException{
    ...
    static String[] token(String text)throws IOException{
    ...
    static String category(DoccatModel doccatModel, String[] tk){
